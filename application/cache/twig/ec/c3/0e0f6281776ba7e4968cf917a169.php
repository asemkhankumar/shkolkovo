...
/* manage/expertcomments/index.twig */
class __TwigTemplate_ecc30e0f6281776ba7e4968cf917a169 extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($_Url_, "site", array(0 => ("expert/view/" . $this->getAttribute($_item_, "opinion_id"))), "method"), "html", null, true);
            echo "\">";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_item_, "opinion"), "title"), "html", null, true);
            echo "</a>
                        &nbsp;(";
            // line 10
            ...
            // line 12
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            if (($this->getAttribute($_item_, "moderator_decision") == 1)) {
                echo "success";
            } else {
                echo "warning";
            }
            ...
            if (isset($context["Url"])) { $_Url_ = $context["Url"]; } else { $_Url_ = null; }
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_Url_, "site", array(0 => ("manage/expertcomments/show/" . $this->getAttribute($_item_, "id"))), "method"), "html", null, true);
            ...
            echo ": ";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, strip_tags($this->getAttribute($_item_, "text")), "html", null, true);
            echo "</div>
                </div>
            </div>
        ";
...
";
    ...
    {
        return "manage/expertcomments/index.twig";
    }
