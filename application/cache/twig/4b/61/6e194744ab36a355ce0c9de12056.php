...
/* manage/materials/index.twig */
class __TwigTemplate_4b616e194744ab36a355ce0c9de12056 extends Twig_Template
{
    ...
    <div class=\"titul\" style=\"margin: 10px;\">
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($_URL_, "site", array(0 => "manage/materials"), "method"), "html", null, true);
        echo "?sort=work\"
           ";
        // line 6
        ...
        echo ">";
        echo twig_escape_filter($this->env, __("On the job"), "html", null, true);
        echo "</a>
        <a href=\"";
        // line 7
        if (isset($context["URL"])) { $_URL_ = $context["URL"]; } else { $_URL_ = null; }
        ...
        echo ">";
        echo twig_escape_filter($this->env, __("Approved Materials"), "html", null, true);
        echo "</a>
        <a href=\"";
        // line 9
        if (isset($context["URL"])) { $_URL_ = $context["URL"]; } else { $_URL_ = null; }
        ...
        echo ">";
        echo twig_escape_filter($this->env, __("Rejected materials"), "html", null, true);
        echo "</a>
        <a href=\"";
        // line 11
        if (isset($context["URL"])) { $_URL_ = $context["URL"]; } else { $_URL_ = null; }
        ...
        echo ">";
        echo twig_escape_filter($this->env, __("All material"), "html", null, true);
        echo "</a>
    </div>
...
";
    ...
    {
        return "manage/materials/index.twig";
    }
    ...
    {
        return array (  182 => 36,  177 => 33,  168 => 31,  157 => 27,  148 => 26,  119 => 23,  115 => 22,  109 => 21,  99 => 16,  93 => 15,  82 => 12,  77 => 11,  68 => 10,  63 => 9,  54 => 8,  49 => 7,  40 => 6,  35 => 5,  31 => 3,  28 => 2,);
    }
}
